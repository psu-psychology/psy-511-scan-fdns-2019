...
```{r, fig.cap="Darwin"}
knitr::include_graphics("https://images.gr-assets.com/books/1429139700l/24515.jpg")
```
...
```{r}
knitr::include_graphics("http://puix.org/wp-content/uploads/plutchik-wheel-emotion.png")
```
[@plutchik1980emotion]
...
```{r, fig.cap="[[@Collet1997-ln]](https://www.ncbi.nlm.nih.gov/pubmed/9021649)"}
knitr::include_graphics("https://ars.els-cdn.com/content/image/1-s2.0-S0165183896001087-gr5.jpg")
```
...
```{r, fig.cap="[[@Chan2010-xr]](http://dx.doi.org/10.1177/2042018810380214)"}
knitr::include_graphics("https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3475279/bin/10.1177_2042018810380214-fig1.jpg")
```
...
```{r, fig.cap="[[@Lang1993-mw]](https://www.ncbi.nlm.nih.gov/pubmed/8497555)"}
knitr::include_graphics("img/lang-93-fig01.jpg")
```

```{r, fig.cap="[[@Lang1993-mw]](https://www.ncbi.nlm.nih.gov/pubmed/8497555)"}
knitr::include_graphics("img/lang-93-fig02.jpg")
```
...
```{r, fig.cap="Motta-Mena, N.V. & Scherf, K.S. (2016). Pubertal development shapes perception of complex facial expressions. Databrary. Retrieved November 8, 2019 from http://doi.org/10.17910/B7.272"}
...
```{r, fig.cap="Fear: amygdala (yellow); Disgust: insula (green); Anger: OFC (rust); Sadness: ACC (blue). [[@Lindquist2012-jr]](http://doi.org/10.1017/S0140525X11000446)"}
knitr::include_graphics("https://static.cambridge.org/binary/version/id/urn:cambridge.org:id:binary-alt:20170929032249-94786-mediumThumb-S0140525X11000446_fig1g.jpg?pub-status=live")
```

### 'Constructionist' view {.smaller}

```{r, fig.cap="Core Affect (pink): amygdala, insula, mOFC (Bas 10m, 11m, 13a, b, 14r, c), lOFC (BAs 47, 12, 13l, m, 11l), ACC (Bas, 32, 24, 25), thalamus, hypothalamus, bed nucleus of the stria terminalis, basal forebrain, PAG. Conceptualization (purple): VMPFC (Bas 11, 25, 32, 34), DMPFC (BAs 9, 10p), medial temporal lobe* (hippocampus, entorhinal cortex, parahippocampal cortex), posterior cingulate cortex/retrosplenial area (BA 23, 31). Language (green): VLPFC (Bas 44, 45, 46), anterior temporal lobe (BA 38); for additional regions, see Vigneau et al. (2006). Executive Attention (orange): DLPFC (BAs 9, 10, 46), VLPFC (BAs 44, 45, 46). [[@Lindquist2012-jr]](http://doi.org/10.1017/S0140525X11000446)"}
knitr::include_graphics("https://static.cambridge.org/binary/version/id/urn:cambridge.org:id:binary-alt:20170929032249-44761-mediumThumb-S0140525X11000446_fig2g.jpg?pub-status=live")
```

```{r, fig.cap="[[@Lindquist2012-jr]](http://doi.org/10.1017/S0140525X11000446)"}
knitr::include_graphics("https://static.cambridge.org/binary/version/id/urn:cambridge.org:id:binary-alt:20170929032249-18687-mediumThumb-S0140525X11000446_fig6g.jpg?pub-status=live")
```
...
```{r, fig.cap="[[@Kragel2016-pe]](http://doi.org/10.1371/journal.pbio.2000106)"}
knitr::include_graphics("http://journals.plos.org/plosbiology/article/figure/image?size=large&download=&id=10.1371/journal.pbio.2000106.g001")
```

```{r, fig.cap="[[@Kragel2016-pe]](http://doi.org/10.1371/journal.pbio.2000106)"}
knitr::include_graphics("http://journals.plos.org/plosbiology/article/figure/image?size=large&download=&id=10.1371/journal.pbio.2000106.g002")
```
...
```{r, fig.cap="[@swanson2012brain]"}
knitr::include_graphics("img/swanson-fig-7.5.jpg")
```

```{r, fig.cap="[[@pessoa_relationship_2008]](http://dx.doi.org/10.1038/nrn2317)"}
knitr::include_graphics("img/pessoa-nrn.jpg")
```
...
```{r, fig.cap="[[@nummenmaa2014bodily]](http://dx.doi.org/10.1073/pnas.1321664111)"}
knitr::include_graphics("http://www.pnas.org/content/111/2/646/F1.medium.gif")
```

```{r, fig.cap="[[@nummenmaa2014bodily]](http://dx.doi.org/10.1073/pnas.1321664111)"}
knitr::include_graphics("http://www.pnas.org/content/111/2/646/F2.medium.gif")
```
