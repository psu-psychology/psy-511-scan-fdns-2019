...
```{r, fig.cap="http://physiologyplus.com/wp-content/uploads/2017/05/milk-ejection-reflex.png"}
knitr::include_graphics("http://physiologyplus.com/wp-content/uploads/2017/05/milk-ejection-reflex.png")
```
