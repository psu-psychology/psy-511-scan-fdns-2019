...
```{r, out.width="700px"}
knitr::include_graphics("http://4.bp.blogspot.com/-j3_rRdZXx0Q/VQXD0vGD8uI/AAAAAAAACr0/MYTD4MhC8rY/s1600/tractography_2014%2Bcopy.png")
```
</div>
...
```{r, out.width="800px"}
knitr::include_graphics("http://www.neurofisiologia.net/wp-content/uploads/2009/07/corticografia.jpg")
```
...
```{r, out.width="800px"}
knitr::include_graphics("http://mriquestions.com/uploads/3/4/5/7/34572113/convolution-of-3-events_orig.gif")
```
...
```{r, out.width="700px"}
knitr::include_graphics("http://neurofeedbackalliance.org/wp-content/uploads/2016/10/Dipole.jpg")
```
...
<div class="centered">
```{r, out.width="700px"}
knitr::include_graphics("http://www.ijbem.org/volume4/number2/nfigs2/image054.jpg")
```
...
- Analyze activity in different 'bands' of frequencies
    ...
    + HIGHER: Sensorimotor activity reflecting observed actions? (mu or $\mu$ band), [[@Hobson2017-oj]](http://dx.doi.org/10.1098/rsos.160662)
    + HIGHER STILL: “Binding” information across senses or plasticity? (gamma or $\gamma$ band), [[@Amo2017-tz]](http://dx.doi.org/10.1371/journal.pone.0186008)
...
<!-- </a> -->
```{r, out.width="700px"}
knitr::include_graphics("http://2.bp.blogspot.com/_2ob-1_LsjJs/TAUjw9i_dYI/AAAAAAAAAQQ/9AfiHsnD-P8/s1600/ERP_technique.gif")
```
...
```{r, out.height="500px"}
knitr::include_graphics("http://s.hswstatic.com/gif/brain-computer-interface-3.gif")
```
...
```{r, out.height="500px"}
knitr::include_graphics("http://www.massgeneral.org/psychiatry/assets/images/Magnetoencephalography_MEG_MGH.jpg")
```
...
```{r, out.height="500px"}
knitr::include_graphics("http://onlinestorybank.com/wp-content/uploads/2014/03/Phineas-Gage.png")
```
</div>
...
```{r, out.width="600px"}
knitr::include_graphics("http://www.nature.com/nrn/journal/v7/n2/images/nrn1848-f4.jpg")
```
