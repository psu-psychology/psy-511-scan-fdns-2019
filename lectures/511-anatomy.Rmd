...
```{r, fig.cap="http://www.scienceteacherprogram.org/biology/chillemistudentguide1-06/brain_directions_planes_sections__directions_-_small.gif"}
...
```{r}
knitr::include_graphics("http://surgery.med.miami.edu/images/Circulation_of_brain.gif")
```
...
```{r}
knitr::include_graphics("https://en.wikipedia.org/wiki/Skull")
```
